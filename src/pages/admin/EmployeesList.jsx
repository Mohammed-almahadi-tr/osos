        ...
        <div className="space-y-6">
            <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-4 bg-white p-6 rounded-2xl shadow-sm">
                ...
                <div className="flex gap-4 w-full md:w-auto">
                    ...
                    <button onClick={() => navigate('/admin/add-employee')} className="bg-primary hover:bg-primary/90 text-white px-6 py-2.5 rounded-xl font-bold text-sm flex items-center gap-2 shadow-lg transition-colors whitespace-nowrap">
